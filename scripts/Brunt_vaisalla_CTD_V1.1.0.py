...
# cria o dataframe
data = pd.read_csv('/home/labdino/PycharmProjects/Internal_waves/dados/01_radial_1/0626_28072019_1609/FILE1_10m.csv')
...
def plotvaisala(n2):
    ...
    plt.title('Perfil de Frequência de Brunt-Väisälä - 10m bins')
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('/home/labdino/PycharmProjects/Internal_waves/dados/01_radial_1/0626_28072019_1609/bruntvaisala_10m.png', format='png', dpi=900, transparent=False)
